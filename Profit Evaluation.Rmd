...
final_prof <- people * (final_cm2$table[2, 2] * 170000 - final_cm2$table[1, 2] * 185000 - final_cm2$table[2, 1] * 12000 + final_cm2$table[1, 1] * 8000) / sum(final_cm2$table)
log_prof <- people * (cm_log$table[2, 2] * 170000 - cm_log$table[1, 2] * 185000 - cm_log$table[2, 1] * 12000 + cm_log$table[1, 1] * 8000) / sum(cm_log$table)
las_prof <- people * (cm_logL$table[2, 2] * 170000 - cm_logL$table[1, 2] * 185000 - cm_logL$table[2, 1] * 12000 + cm_logL$table[1, 1] * 8000) / sum(cm_logL$table)
knn_prof <- people * (cm_knn$table[2, 2] * 170000 - cm_knn$table[1, 2] * 185000 - cm_knn$table[2, 1] * 12000 + cm_knn$table[1, 1] * 8000) / sum(cm_knn$table)
ann_prof <- people * (cm_ann$table[2, 2] * 170000 - cm_ann$table[1, 2] * 185000 - cm_ann$table[2, 1] * 12000 + cm_ann$table[1, 1] * 8000) / sum(cm_ann$table)
dt_prof <- people * (cm_tree$table[2, 2] * 170000 - cm_tree$table[1, 2] * 185000 - cm_tree$table[2, 1] * 12000 + cm_tree$table[1, 1] * 8000) / sum(cm_tree$table)
rf_prof <- people * (cm_rf$table[2, 2] * 170000 - cm_rf$table[1, 2] * 185000 - cm_rf$table[2, 1] * 12000 + cm_rf$table[1, 1] * 8000) / sum(cm_rf$table)
svm_prof <- people * (cm_svm$table[2, 2] * 170000 - cm_svm$table[1, 2] * 185000 - cm_svm$table[2, 1] * 12000 + cm_svm$table[1, 1] * 8000) / sum(cm_svm$table)
...
bp <- barplot(profit,
        ...
        xlab = "Model",
        col = colors,
        ylim = c(min(profit) * 1.1, max(profit) * 1.5))
